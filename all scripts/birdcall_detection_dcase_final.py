...
SAVE_CHECKPOINTS = False # Save the model after every epoch
...
MODEL_NAME = "BIRDCALL_DETECTION_DCASE_FINAL"

# Preprocessing info
SAMPLE_RATE = 32000 # Desired sample rate
...
train_dataset = DCaseData(signals = dcase['signal'].to_list(), 
