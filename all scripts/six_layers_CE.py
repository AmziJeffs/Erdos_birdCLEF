...
# 
# CURRENT PIPELINE:
# Sample randomly from each clip, durations are used to weight the sampling
# so that each species is equally likely to be sampled, and within that
# each clip is weighted by duration.
MODEL_NAME = "SIX_LAYERS_CE_FIRSTMIN"
